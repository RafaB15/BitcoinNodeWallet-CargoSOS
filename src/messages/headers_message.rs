...
mod tests {
    ...
    fn test_01_correct_headers_message_serialization() {
        ...
        CompactSize::new(field.len() as u64).le_serialize(&mut serialized_block_header_fields).unwrap();
        ...
        header_message.io_serialize(&mut serialized_header_message).unwrap();
    ...
    fn test_02_correct_headers_message_deserialization() {
        ...
        let deserialized_header_message = HeadersMessage::io_deserialize(&mut serialized_header_message.as_slice()).unwrap();
