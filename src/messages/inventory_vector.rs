...
mod tests {
    ...
    use crate::block_structure::hash::{HashType, self};
    ...
    fn test_01_correct_inventory_vector_serialization() {
        ...
        type_identifier.le_serialize(&mut serialized_fields).unwrap();
    ...
    fn test_02_correct_inventory_vector_deserialization() {
        ...
        let deserialized_message = InventoryVector::io_deserialize(&mut serialized_message.as_slice()).unwrap();
