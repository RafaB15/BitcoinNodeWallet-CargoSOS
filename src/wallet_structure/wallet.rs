...
mod tests {
    ...
    fn test_02_correct_wallet_serialization() {
        ...
        (account_vector.len() as u64).le_serialize(&mut serialized_fields).unwrap();
    ...
    fn test_03_correct_wallet_deserialization() {
        ...
        let deserialized_wallet = Wallet::io_deserialize(&mut serialized_wallet.as_slice()).unwrap();
