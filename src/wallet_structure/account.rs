...
mod tests {
    ...
    fn test_2_correct_account_serialization() {
        ...
        (account_name.len() as u64).le_serialize(&mut serialized_fields).unwrap();
    ...
    fn test_3_correct_account_deserialization() {
        ...
        let deserialized_account = Account::io_deserialize(&mut serialized_transaction.as_slice()).unwrap();
