...
mod tests {
    ...
    fn test_02_correct_signature_script_creation() {
        ...
        let transaction_to_sign = Transaction::io_deserialize(&mut transaction_to_sign_bytes).unwrap();
        let sig_script = TransactionInput::create_signature_script(&account, transaction_to_sign, 0).unwrap();
